...
public class FromDUALListLocation extends PApplet {
	...
	//Change below to false if remote (Https: earthquake information is not available)
	private boolean isRemoteLocationAvailable = false;
...
//		myMap = new UnfoldingMap(this, 200, 50, 700, 500, new Microsoft.RoadProvider());
		...
		//Uses remote or local information
		if(isRemoteLocationAvailable){
			//Below https adress is reached to get the earthquaques points
		    earthquakesURL = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/2.5_week.atom";
		}else{
